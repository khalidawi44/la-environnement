<?php
/**
 * Template Name: Accueil sobre (sections)
 *
 * Variante calme de l'accueil : les mêmes contenus, sans la scène animée.
 * À assigner à une page depuis l'administration si l'accueil cinématique
 * (front-page.php) est un jour jugé trop chargé.
 *
