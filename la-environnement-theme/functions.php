...
require_once get_template_directory() . '/inc/lae-gazon.php';
require_once get_template_directory() . '/inc/lae-maillage.php';
require_once get_template_directory() . '/inc/lae-abattage.php';
require_once get_template_directory() . '/inc/lae-prestations-2.php';
require_once get_template_directory() . '/inc/lae-illustration.php';
require_once get_template_directory() . '/inc/lae-ambiance.php';
require_once get_template_directory() . '/inc/lae-articles.php';
require_once get_template_directory() . '/inc/lae-hardening.php';
require_once get_template_directory() . '/inc/lae-zero-tiers.php';
require_once get_template_directory() . '/inc/lae-cache-http.php';
require_once get_template_directory() . '/inc/lae-purge-forcee.php';
require_once get_template_directory() . '/inc/lae-partage.php';
require_once get_template_directory() . '/inc/lae-seo-tech.php';

// ── Design et contenu ───────────────────────────────────────────────
require_once get_template_directory() . '/inc/lae-defauts.php';
...
require_once get_template_directory() . '/inc/lae-seo-pages.php';
require_once get_template_directory() . '/inc/lae-schema-pages.php';
